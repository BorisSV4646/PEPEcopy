$(document).ready(function () {
  ...
  $('.swap-tokens-block-item').click(function () {
    ...
    swapSelector
      ...
      .prepend(`<span>${$(this).find('.swap-tokens-block-item-text').text()}</span>`);
    swapSelector
      .find('.swap-block-item-selector-text')
      .prepend(
        `<img src="${$(this).find('.swap-tokens-block-item-icon img').attr('src')}" alt="">`,
      );
    swapSelector = '';
    $('.swap-tokens-bg').removeClass('active');
    $('.swap-tokens-block').removeClass('active');
  ...
  if ($('.staking-pool-range').length) {
    ...
    $('.staking-pool-tab').click(function () {
      ...
      $(`.staking-pool-content[data-tab="${$(this).attr('data-tab')}"]`).addClass('active');
    });
